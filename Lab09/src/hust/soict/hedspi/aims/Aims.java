...
public class Aims {
			...
			switch (selected) {
				...
				case 2:
					...
					if (type != 0) {
						...
						switch (type) {
							case 1:
								media = createDVD(order.getItemOrdered().size()+1, title, category, cost);
								do {
								...
								break;
							case 2:
								media = createCD(order.getItemOrdered().size()+1, title, category, cost);
								do {
									System.out.println("Do you want to play this DVD?");
									System.out.println("1. Yes");
									System.out.println("0. No");
								...
								break;
							case 3:
								media = createBook(order.getItemOrdered().size()+1, title, category, cost);
								break;
						}
	...
	public static Media createDVD(int id, String title, String category, float cost){
		System.out.println("Director: ");
		String director = scanner.nextLine();
		System.out.println("Length: ");
		int length = scanner.nextInt();
		Media dvd = new DigitalVideoDisc(id,title, category, director, length, cost);
		return dvd;
	}

	public static Media createCD(int id,String title, String category, float cost){
		System.out.println("Artist: ");
		String artist = scanner.nextLine();
		Media cd = new CompactDisc(id, title, category, cost, artist);
		int selected;
		do{
	...
	public static Media createBook(int id,String title, String category, float cost){
		Media book = new Book(id,title, category, cost);
		int selected;
		do{
